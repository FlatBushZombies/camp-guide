...
const Camp = () => {
  return (
    <section className='2xl:max-container relative flex flex-col py-10 lg:mb-10
    lg:py-20 xl:mb-20'>
      ...
      lg:h-[400px] xl:h-[640px]'>
        ...
        title = "RestHaven Retreat"
        subtitle = "Domboshava, Goromonzi"
      ...
      <div className="flexEnd mt-10 px-6  lg:-mt-60 lg:mr-6">
        ...
        relative w-full overflow-hidden rounded-3xl">
          <h2 className="regular-24 md:regular-32 2xl:regular-64 capitalize text-white">
            <strong>
            Explore Zimbabwe </strong>
             and Camping Spots!
          </h2>
          <p className="regular-14 xl:regular-16 mt-5 text-white">
            Care for a picnic in the wild. Use the guidance of Camp Guide to explore nature
            without the anxiety of getting lost, YES even the rock climbers visiting a new location.
          </p>
